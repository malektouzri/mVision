package com.mVision.myProject.utils;
	...
	public static boolean init(AssetManager assetMana) {
		...
		if (!dir.exists()) {
			...
			try {
				...
				InputStream inStream = assetMana.open("CSDL/fra.traineddata");
				FileOutputStream outStream = new FileOutputStream(datapath + "tessdata/fra.traineddata");
